...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsCircular
{
    ...
    /// </summary>
    internal class WndWall_231CircleOpeningWithLinerAndSealingRing : IOpeningCircular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.CircleOpeningWithBushsingAndSealingRing_WindowWall_231;

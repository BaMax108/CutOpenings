...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsCircular
{
    ...
    /// </summary>
    internal class WndWall_231CircleOpening : IOpeningCircular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.CircleOpening_WindowWall_231;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "231_Отверстие круглое (Окно_Стена)";

...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsCircular
{
    ...
    /// </summary>
    internal class GmEdg_231OvVkInputUnitSansCuttingReinforcement : IOpeningCircular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.OvVkInputUnitSansCuttingReinforcement_GenericModelEdge_231;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "231_Узел ввода ОВ и ВК без вырезания арматуры (ОбщМод_Грань)";
        ...
        public XYZ SetLocationPoint(Document doc, XYZ basePoint, Element element, XYZ linkPosition)
        {
            ...
            return param == null ? default : (bb.Max + bb.Min) / 2 + basePoint + linkPosition - new XYZ(0, 0, param.AsDouble() / 2);
        }
    }
}

...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    /// </summary>
    internal class WndWall_231RectangularOpening : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.RectangularOpening_WindowWall_231;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "231_Отверстие прямоугольное (Окно_Стена)";

...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    /// </summary>
    internal class WndFlr_232RechtangularOpeningWithReinforcement : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.RechtangularOpeningWithReinforcement_WindowFloor_232;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "232_Проем прямоуг с армированием (Окно_Плита)";

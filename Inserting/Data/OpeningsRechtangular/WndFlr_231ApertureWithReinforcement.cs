...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    internal class WndFlr_231ApertureWithReinforcement : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.ApertureWithReinforcement_WindowFloor_231;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "231_Проем с армированием (Окно_Стена)";

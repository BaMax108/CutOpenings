...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    /// </summary>
    internal class GmEdg_232ReinforcedOpeningSansCuttingReinforcement : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.ReinforcedOpeningSansCuttingReinforcement_GenericModelEdge_232;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "232_Армированное отверстие без вырезания арматуры (ОбщМод_Грань)";
        ...
        public XYZ SetLocationPoint(Document doc, XYZ basePoint, Element element, XYZ linkPosition)
        {
            ...
            if (!(element is FamilyInstance familyInstance)) return default;

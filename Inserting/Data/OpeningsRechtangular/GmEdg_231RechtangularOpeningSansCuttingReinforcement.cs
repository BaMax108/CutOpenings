...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    /// </summary>
    internal class GmEdg_231RechtangularOpeningSansCuttingReinforcement : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.RechtangularOpeningSansCuttingReinforcement_GenericodelEdge_231;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "231_Отверстие прямоуг без вырезания арм (ОбщМод_Грань)";
        ...
        public XYZ SetLocationPoint(Document doc, XYZ basePoint, Element element, XYZ linkPosition)
        {
            ...
            return (param == null) ? default : newInstanceLocation - new XYZ(0, 0, param.AsDouble() / 2);
        }
    }
}

...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    /// </summary>
    internal class WndFlr_232RectangularAperture : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.RectangularAperture_WindowFloor_232;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "232_Проем прямоугольный (Окно_Перекр)";

        /// <summary>
        /// Название параметра, отвечающего за высоту экземпляра.
        /// </summary>
        public string Heigh { get; } = "Рзм.Ширина";
        ...
        /// </summary>
        public string Width { get; } = "Рзм.Высота";

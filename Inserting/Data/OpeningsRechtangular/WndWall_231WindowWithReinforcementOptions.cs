...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    /// </summary>
    internal class WndWall_231WindowWithReinforcementOptions : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.WindowWithReinforcementOptions_WindowWall_231;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "231_Окно с вариантами армирования (Окно_Стена)";

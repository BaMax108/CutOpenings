...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    /// </summary>
    internal class WndFlr_232TemporaryOpening : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.TemporaryOpening_WindowFloor_232;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "232_Проем временный (Окно_Плита)";

...
namespace CutOpeningsPlugin.Inserting.Data.OpeningsRechtangular
{
    ...
    /// </summary>
    internal class GmEdg_231ReinforcedOpeningSansCuttingReinforcement : IOpeningRechtangular
    {
        #region Свойства

        public ValidOpenings ValidOpenings { get; } = ValidOpenings.ReinforcedOpeningSansCuttingReinforcement_GenericModelEdge_231;

        /// <summary>
        /// Название семейства.
        /// </summary>
        public string Name { get; } = "231_Армированное отверстие без вырезания арматуры (ОбщМод_Грань)";
